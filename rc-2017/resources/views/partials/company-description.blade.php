...
<hr>
  ...
   
  <div>We do plenty of high-end custom work and it’s important that we have a foolproof system to guarantee that everything goes smoothly. Our process includes:</div>
  <li>Phase one - preliminary plans & preliminary estimates</li>
  <li>Phase two - developing the working construction drawings</li>
  <li>Phase three - final selections, contract agreements, & timelines</li>
  <li>Phase four - the construction process begins</li>
  <div>We also offer handyman and repair services including:</div>
  <div><li>Small deck projects</li>
